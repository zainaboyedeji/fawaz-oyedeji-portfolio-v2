...
function App() {
                    ...
                    <main className="flex flex-col flex-grow justify-between">
                        <Routes>
                            <Route
                                ...
                                element={
                                    <AnimatePresence mode="wait">
                                        <Gallery photos={homePhotosMetadata} category="home" alt="home" />
                                    </AnimatePresence>
                                }
                            />
                            <Route
                            ...
                            <Route
                                ...
                                element={
                                    <AnimatePresence mode="wait">
                                        <Gallery photos={tearSheetPhotosMetadata} category="ts" alt="Tear Sheet" title="Press news, articles, and client’s work." />
                                    </AnimatePresence>
                                }
                            />
  ...
  rel="noopener noreferrer"
            title="Gun For Hire"
            className="ml-2 openLink text-red-800"
          >
            Gun for hire.
          </a>
        </p>
